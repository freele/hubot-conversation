...
module.exports = function Conversation(bot, type, finalCb) {
    ...
    bot.catchAll((msg) => {
        ...
        // this.startDialog(msg, '9999');
        var id = getId(msg.message);
        _talkingTo[id] && _talkingTo[id].receive(msg);
    });
    ...
    this.startDialog = function startDialog(msg, timeout, timeoutMessage) {
        var id = getId(msg.message),
            dialog = _talkingTo[id] = new Dialog(msg, timeout, timeoutMessage, bot, finalCb);
